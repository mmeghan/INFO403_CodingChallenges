#input- integerts k and t followed by a space separated collection of strings DNA
#output- a collection BestMotifs resulting from running RandomizedMotifSearc(DNA,k,t) 1,000 times
import random
...
inputs = readFile('dataset_609083_5.txt')
dna = inputs[0]
print(dna)
k = inputs[1]
print(k)
